...
vespid-ai は、trustworthy agent execution に必要なシステム層、つまり agent runtime、delegated authorization、sandboxed execution、protected actions、portable context / memory、operator tooling、そして GEO / AI search discoverability を中心に構築しています。
...
| Discovery and distribution | [`geo-skill`](https://github.com/vespid-ai/geo-skill) | AI Search / ChatGPT Search / llms.txt 向けの GEO skill pack と CLI。公開面の machine-readable discoverability を改善するためのレイヤー |
...
GitHub、docs site、llms.txt、structured data を揃え、AI-native discovery に対して読める公開面を作ります。
